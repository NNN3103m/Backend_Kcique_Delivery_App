...
class CustomerModel {
    ...
    @field:Min(1)
    @field:Max(15)
    @field:NotBlank(message = "Profavor ingresar un id")
    var id: Int? = null

    @Column(name = "mobileNumber", unique = true, insertable = true, nullable = false )
    @field:Min(9)
    @field:Max(17)
    @field:NotBlank(message = "Profavor ingresar un numero de telefono")
    var mobile: String? = null

    @Column(name = "customerName", insertable = true, nullable = false )
    @field:Min(2)
    @field:Max(56)
    @field:NotBlank(message = "Profavor ingresar un nombre")
    var name: String? = null

    @Column(name = "customerEmail", unique = true, insertable = true, nullable = false )
    @field:Min(8)
    @field:Max(60)
    @field:NotBlank(message = "Profavor ingresar un email")
    @field:Email
    ...
    @field:Min(14)
    @field:Max(16)
    @field:NotBlank(message = "Porfavor ingrese una tarjeta de Credito/Debito")
